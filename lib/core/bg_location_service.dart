...
class BackgroundLocationService {
  static const _channelId = 'mandena_driver_channel';
  static const _channelName = 'Mandena Driver Tracking';
  ...
  static Future<void> init() async {
    ...
    await service.configure(
      androidConfiguration: AndroidConfiguration(
        ...
        initialNotificationTitle: 'Mandena Driver',
  ...
  static Future<void> _initNotificationChannel() async {
    ...
    const androidChannel = AndroidNotificationChannel(
      ...
      importance: Importance.low, // foreground عادة low/balanced
    );
